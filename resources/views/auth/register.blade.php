...
<head>
    ...
    <title>Register - CrickTracker KUET</title>
...
<body>
    ...
    <div class="auth-card">
        <div class="auth-brand fs-3 text-uppercase">
            ...
            <div class="fs-6 text-muted fw-normal mt-1">Create Account Portal</div>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" value="{{ old('name') }}" required autofocus placeholder="Your Name">
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="email" id="email" name="email" class="form-control" value="{{ old('email') }}" required placeholder="your_roll@stud.kuet.ac.bd">
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    <span class="input-group-text bg-light text-muted"><i class="fa-solid fa-shield-check"></i></span>
            ...
            <div class="text-center small text-muted">
                Already have an account? <a href="{{ route('login') }}" class="text-primary fw-bold text-decoration-none">Sign In instead</a>
            </div>
        </form>
    </div>
